...
1. search_rentals[location, max_price, room_type]: Tra cứu phòng trọ / căn hộ cho thuê theo khu vực, mức giá tối đa (VNĐ) và loại phòng.
2. check_viewing_slots[property_id, date]: Kiểm tra các khung giờ trống để xem phòng theo mã phòng và ngày (YYYY-MM-DD).
3. book_viewing_appointment[property_id, customer_name, phone, date, time_slot]: Đặt lịch hẹn xem phòng cho khách hàng.
