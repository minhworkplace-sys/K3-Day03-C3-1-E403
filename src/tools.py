...
# Compatibility aliases for legacy & updated test cases
def get_weather(location: str) -> str:
    return search_rentals(location)
...
def search_listings(location: str = "", max_price: int = 10000000, room_type: str = "", min_price: int = 0, type: str = "", amenities: list = None) -> str:
    return search_rentals(location, max_price, room_type or type)

def get_listing_details(listing_id: str = "APT-2024-007") -> str:
    return search_rentals(listing_id)

def check_availability(listing_id: str = "", date: str = "", time: str = "") -> str:
    return check_viewing_slots(listing_id, date)

def book_viewing(listing_id: str = "", customer_name: str = "Khách hàng", phone: str = "0912345678", date: str = "2026-08-01", time: str = "10:00") -> str:
    return book_viewing_appointment(listing_id, customer_name, phone, date, time)
